...
const Footer = () => {
	return (
		<div className="">
			<div className="bg-sky-400 flex justify-center py-6">
				<div className="max-w-6xl xl:px-0 px-4 w-full mx-auto grid grid-cols-1 md:grid-cols-3 space-y-6 md:space-y-0 divide-y-2 md:divide-y-0">
					<div className="w-full flex ">
						{/* Links */}

						<div className="flex flex-col">
							<h1 className="font-semibold text-lg mb-2 text-slate-100">
								Muse.
							</h1>
					...
					<div className="w-full flex flex-col pt-6 md:pt-0">
						<h1 className="font-semibold text-lg mb-1 text-slate-100">
							Newsletter
						</h1>
						<p className="text-slate-100 text-sm mb-2">
							Get notified about new posts, updates and promotions on Muse.
						</p>
						<input
							type="email"
							className="px-3 py-2 rounded-md border border-slate-300 focus:outline-none text-slate-800 mb-3 placeholder:text-slate-300 placeholder:text-sm"
							placeholder="Email adres"
						/>
						<button className=" w-full md:w-max space-x-3 px-3 py-2  flex items-center bg-sky-700 text-slate-100 rounded-lg hover:bg-sky-800 focus:ring focus:ring-sky-500 focus:ring-opacity-25">
							<svg
								xmlns="http://www.w3.org/2000/svg"
								className="h-5 w-5"
								fill="none"
							...
							<h1 className="">Sign me up</h1>
						</button>
					</div>
				</div>
			</div>
			<div className="h-8 bg-sky-600 flex justify-center items-center">
				<h1 className="text-sm text-white font-semibold">Copyright © Muse.</h1>
			</div>
		</div>
	)
}
